...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-semibold ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-[#1B54FF] text-white hover:bg-[#124bd2] shadow-md hover:shadow-lg btn-glow",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline:
          "border border-[#1B54FF]/20 bg-white text-[#1B54FF] hover:bg-[#1B54FF]/5 hover:border-[#1B54FF]/40",
        secondary:
          "bg-[#f0f4ff] text-[#1B54FF] hover:bg-[#e0e9ff]",
        ghost:
          "hover:bg-accent hover:text-accent-foreground",
        link:
          "text-[#1B54FF] underline-offset-4 hover:underline",
      },
      size: {
